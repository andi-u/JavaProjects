...
public class Main {
    private static final String INVALID_VALUE_MESSAGE = "Invalid value"; // final word is equivalent to const in C++
    ...
    private static String getDurationString(long minutes, long seconds) {
        ...
        if((minutes >= 0) && (seconds >= 0) && (seconds <= 59)) {
            long minCalc, hourCalc;
            hourCalc = (long)minutes/60;
            minCalc = (long)minutes%60;
            String hoursString = hourCalc + "h ";
            if(hourCalc < 10) {
                hoursString = "0" + hoursString;
            }
            String minString = minCalc + "m ";
            if(minCalc < 10) {
    ...
    private static String getDurationString(long seconds) {
        ...
        if(seconds > 0){
            ...
            long calcSeconds = (long)seconds%60;
            result = getDurationString(minutes, calcSeconds);
        }
        return result;
    }
}
