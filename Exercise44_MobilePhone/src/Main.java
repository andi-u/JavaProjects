public class Main {
    public static void main(String[] args) {
        MobilePhone myMobilePhone = new MobilePhone("0723580014");
        myMobilePhone.addNewContact(Contact.createContact("Bob", "31415926"));
        myMobilePhone.addNewContact(Contact.createContact("Alice", "16180339"));
        myMobilePhone.addNewContact(Contact.createContact("Tom", "11235813"));
        myMobilePhone.addNewContact(Contact.createContact("Jane", "23571113"));

        myMobilePhone.printContacts();

        Contact paul = new Contact("Paul", "77777777777");
        Contact test = new Contact("test", "1");
        myMobilePhone.addNewContact(paul);

        System.out.println(myMobilePhone.removeContact(paul));
