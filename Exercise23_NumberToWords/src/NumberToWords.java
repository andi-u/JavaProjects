public class NumberToWords {
    ...
    public static int reverse(int number) {
        ...
        int current = 0;
        while(newNumber != 0) {
            current = current * 10 + newNumber%10;
            newNumber /= 10;
        }
        return current * sign;
    }
    ...
    * numberToWords(-12); should print "Invalid Value" since the parameter is negative.
    ...
    NOTE: The methods numberToWords, getDigitCount, reverse should be defined as public static like we have been doing
